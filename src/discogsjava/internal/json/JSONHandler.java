...
public class JSONHandler
{
     ...
     *
     * @param obj    object to extract a list from.
     * @param field  field to parse.
     * @param parser single item parser.
     * @return parsed objects.
     * @throws org.json.JSONException if format is invalid.
     */
     ...
     * @param dateFormat field date format.
     * @return data format.
     * @throws org.json.JSONException if error occurs.
     */
     ...
     *
     * @param obj   object to get a field from.
     * @param field field to get a value from.
     * @throws org.json.JSONException if value is not valid
     */
     ...
     *
     * @param obj   object to get a field from.
     * @param field field to get a value for.
     * @return boolean value.
     * @throws org.json.JSONException if input is not valid (field value is not boolean).
     */
     ...
     * @param obj   object to get a field from.
     * @param field field to get a value from.
     * @throws org.json.JSONException if value is not valid, not exists, etc...
     */
     ...
     *
     * @param obj   object to get a field from.
     * @param field returned field.
     * @return object field.
     * @throws org.json.JSONException if target field is not an object.
     */
    ...
    public static List<String> getListStringOrNull(JSONObject obj, String field) throws JSONException
    {
        final JSONArray items = getArrayNotNull(obj, field);
        final int length = items.length();
        ...
        for (int i = 0; i < length; i++)
        {
           result.add(items.get(i).toString());
        }
        return result;
    }
}
